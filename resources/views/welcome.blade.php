                ...
                <div class="card h-100">
                    <div class="single-post post-style-1">
                        ...
                        <div class="blog-image"><img
                                src="{{ asset('assets/frontend/images') }}/marion-michele-330691.jpg" alt="Blog Image">
                        </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100">
                    <div class="single-post post-style-1">
                        ...
                        <div class="blog-image"><img
                                src="{{ asset('assets/frontend/images') }}/audrey-jackson-260657.jpg" alt="Blog Image">
                        </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100">
                    <div class="single-post post-style-1">
                        ...
                        <div class="blog-image"><img
                                src="{{ asset('assets/frontend/images') }}/pexels-photo-370474.jpeg" alt="Blog Image">
                        </div>

                        <a class="avatar" href="#"><img
                                src="{{ asset('assets/frontend/images') }}/averie-woodard-319832.jpg"
                                alt="Profile Image"></a>
            ...
            <div class="col-lg-8 col-md-12">
                <div class="card h-100">
                    <div class="single-post post-style-2">
                        ...
                        <div class="blog-image"><img src="{{ asset('assets/frontend/images') }}/brooke-lark-194251.jpg"
                                alt="Blog Image"></div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100">
                    <div class="single-post post-style-1">
                        ...
                        <div class="blog-image"><img src="{{ asset('assets/frontend/images') }}/dmitri-popov-326976.jpg"
                                alt="Blog Image"></div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100">
                    <div class="single-post post-style-1">
                        ...
                        <div class="blog-image"><img
                                src="{{ asset('assets/frontend/images') }}/ben-o-sullivan-382817.jpg" alt="Blog Image">
                        </div>
            ...
            <div class="col-lg-8 col-md-12">
                <div class="card h-100">
                    <div class="single-post post-style-2">
                        ...
                        <div class="blog-image"><img src="{{ asset('assets/frontend/images') }}/icons8-team-355990.jpg"
                                alt="Blog Image"></div>
